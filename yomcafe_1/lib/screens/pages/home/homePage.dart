...
class _HomePageState extends State<HomePage> {
  ...
  Container _container_2(Color color) {
    return  Container(
      width: 12,
      height: 12,
      decoration: BoxDecoration(
        shape: BoxShape.circle,
        border: Border.all(
          color: color == Colors.transparent ? blackColor : color,
          width: 1,
        ),
        color: color,
      ),
      ...
      Scaffold(
          ...
          body: isReady ? Stack(
            children: [
              ...
              MediaQuery.of(context).size.width > 980 ? Positioned.fill(
                  child:
                  Align(
